...
val defaultManagerPackageName = if (isPrBuild) "com.xecpro.kernel.pr" else "com.xecpro.kernel"
val defaultManagerName = if (isPrBuild) "XECKernelPro PR" else "XECKernelPro"
