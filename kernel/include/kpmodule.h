 ...
 *
 * KernelPatch Module (KPM) public ABI header. A KPM is a relocatable AArch64
 * ELF (ET_REL) exposing the sections and function pointers described below.
 * This header is kept source-compatible with KernelPatch's
 * kernel/include/kpmodule.h so existing KPM modules can be built unchanged.
 */
